        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 mb-10 max-w-2xl mx-auto text-center">
              Create a stunning resume with clean templates, real-time preview,
              and instant PDF export. No design experience needed.
            </p>
            <br />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 transform hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Simple form-based interface to enter your information. No
                complicated steps or confusing layouts.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 transform hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                See your resume updates in real-time as you type. Preview
                exactly how your resume will look.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 transform hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Export your resume as a professional PDF file. Ready to submit
